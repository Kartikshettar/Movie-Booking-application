  ...
  const fetchSearch = async () => {
    try {
      const { data } = await axios.get(
        `https://api.themoviedb.org/3/search/${type ? "tv" : "movie"}?api_key=594d4a2e07c4240e4c3b1540eb841369&language=en-US&query=${searchText}&page=${page}&include_adult=false`
      );
